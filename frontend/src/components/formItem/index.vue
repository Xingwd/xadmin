    ...
    setup(props, { emit, slots }) {
        ...
        return () =>
            createVNode(
                ...
                {
                    class: 'xa-input-item-' + props.type,
                    ...attrs.value,
                },
                formItemSlots
            )
...
.xa-form-item-not-support {
    line-height: 15px;
}
.xa-input-item-array :deep(.el-form-item__content) {
    display: block;
    padding-bottom: 32px;
}
</style>
