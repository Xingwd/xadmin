export default {
    ...
    'Please enter the correct account': 'The account requires 2 to 50 characters and contains a-z A-Z 0-9 _',
    'Please enter the correct password': 'The password requires 8 to 40 characters and cannot contains & < > " \'',
